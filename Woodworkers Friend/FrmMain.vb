...
Public Class FrmMain
    ...
    Private Sub CreateProgramFolders()
        Try
            ...
            ' Create Resources subfolder in INSTALLATION folder for app databases
            If Not IO.Directory.Exists(AppResourcesDir) Then
                IO.Directory.CreateDirectory(AppResourcesDir)
            End If
        Catch ex As Exception
